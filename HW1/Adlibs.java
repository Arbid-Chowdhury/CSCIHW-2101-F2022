...
//        color is ___"
public class Adlibs {
    public String story(String name, int i, String favoriteColor) {
        String answer = "Hi, my name is " + name + " I just turned " + i + " Did you know my favorite color was " + favoriteColor + "? ";
