...
public static String Tipcalc(double total, int peps, double percent){    
double newtotal = Math.ceil(total);
double newpercent = percent/100;
double finaltotal = (total + (newtotal * newpercent))/peps;
return "the total per person is " + finaltotal;
}
...
public static void main(String[] args) {
    ...
    System.out.println(Tipcalc(50, 5, 10));
}
}
